...
//				.addAdiacenza(nomeStanzaIniziale, "stanza 5", Direzione.valueOf("nord-est".toUpperCase())) // non dovrebbe essere aggiunta
//				.getLabirinto();
//				Stanza test = new Stanza("stanza 5");
//		assertThrows(IllegalArgumentException.class ,maze.getStanzaIniziale().getStanzaAdiacente(Direzione.valueOf("nord-est".toUpperCase()));
...
//	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		stanzaBloccata.impostaStanzaAdiacente(Direzione.NORD, new Stanza(nomeStanzaIniziale));
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		mapAdiacenti.put(Direzione.NORD,new StanzaBloccata("corridoio bloccato",Direzione.NORD,"chiave"));
		mapAdiacenti.put(Direzione.SUD,new Stanza(nomeStanzaIniziale));
		mapAdiacenti.put(Direzione.EST,new StanzaMagica("stanza magica", 1));
